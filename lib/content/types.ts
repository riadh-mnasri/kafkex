 ...
 * A "content pack" (Kafka today, Rust or GCP tomorrow) is a folder of
 * JSON files that conform to this model. See content/packs/kafka.
 */
...
export interface Pack {
  id: string;
  name: string;
  /** Version of the target technology covered (e.g. Kafka version). */
