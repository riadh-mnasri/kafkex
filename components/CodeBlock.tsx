 ...
 *
 * Minimal syntax highlighting for shell, properties and Java/Kotlin client
 * snippets. A handwritten tokenizer keeps the bundle free of a heavy
 * highlighting dependency; good enough for the short, curated snippets
 * used in lessons and exercises.
 */
...
const KEYWORDS = new Set([
  ...
  "suspend", "in", "out", "is", "as", "try", "catch", "finally", "throw",
  "import", "package", "null", "true", "false", "this", "super", "override",
  "open", "private", "public", "internal", "protected", "static", "final",
  "void", "new", "extends", "implements", "throws",
]);
